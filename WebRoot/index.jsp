  ...
  <body>
    ...
    <table width="788" height="348" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="193" valign="top" bgcolor="#F0F0F0"><jsp:include page="search.jsp"/><jsp:include page="goodsType.jsp"/></td>
            <td width="397" valign="top" bgcolor="#FFFFFF">
										     ...
										     <table width="0" border="0" cellpadding="0" cellspacing="0">
											     <tr>
												       <td height="95" align="center">
												           <img src="images/goods/<%=new_picture%>" width="120" height="80">
												       </td>
											     </tr>
											     <tr>
												       <td height="22" align="center">
												          <a href="goods_detail.jsp?ID=<%=new_ID%>" class="word_green">⊙<%=new_goodsname%></a>
												      </td>
											    </tr>
											    <tr>
											    ...
											    <tr>
												      <td height="22" align="center">
												          <a href="goods_detail.jsp?ID=<%=new_ID%>"><img src="images/btn_detail.GIF" width="52" height="20"></a> 
                ...
                <table width="382" height="76"  border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                            <td>
                                   <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#CFCFCF" style="padding:5px">
                                        <%	while (rs_sale.next())
                                            {
					                     ...
					                     %>
                                         <tr>
                                              <td width="37%" height="95" align="center">
                                                   <img src="images/goods/<%=s_picture%>" width="96" height="61">
                                              </td>
                                              
                                              <td width="63%" align="center" class="word_orange" style="line-height:1.5">
                                                    <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                          ...
                                                          <tr>
                                                                <td height="22">
                                                                            <span class="word_orange" style="line-height:1.5">
                                                                                    <a href="goods_detail.jsp?ID=<%=sale_ID%>">&nbsp;&nbsp;
                                                                                          <img src="images/btn_detail.GIF" width="52" height="20">
                                                                                    </a>
                                                 <%if (username!=null && username!="")
                                                  {%>
                                                                                   &nbsp; 
                                                                                   <a href="cart_add.jsp?goodsID=<%=sale_ID%>">
                                                                                          <img src="images/btn_buy.GIF" width="52" height="20">
                                                                                   </a>
                                                <%}%>
                                                                           </span>
                                                               </td>
