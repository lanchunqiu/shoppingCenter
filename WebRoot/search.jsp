...
<table width="186" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><img src="images/search_bg_top.JPG" width="186" height="44">
		</td>
	</tr>
	<tr>
		<td height="100" background="images/search_bg_bottom.JPG">
			<table width="100%" height="23" border="0" align="center"cellpadding="0" cellspacing="0">
				<form name="form2" method="post" action="search_deal.jsp">
					...
					<tr>
						<td width="85%" height="27" align="center">请输入查询条件： <select
							name="type" class="textarea">
					...
					<tr>
						<td height="27" align="center"><input name="key" type="text"
							class="txt_grey" size="26">
						</td>
					</tr>
					<td width="15%" height="36" align="right"><input name="search"
						type="submit" class="btn_bg_search" value="搜 索">
						&nbsp;&nbsp;&nbsp;</td>
					</tr>
				</form>
			</table>
